	...
	<head>
		...
		<body>
			...
			<section class="default-banner active-blog-slider">
					...
					<div class="item-slider relative" style="background: url(<?php echo base_url()?>asset/img/slider2.jpg);background-size: cover;">
						<div class="overlay" style="background: rgba(0,0,0,.3)"></div>
						<div class="container">
							<div class="row fullscreen justify-content-center align-items-center">
								<div class="col-md-10 col-12">
					...
					<div class="item-slider relative" style="background: url(<?php echo base_url()?>asset/img/slider3.jpg);background-size: cover;">
						<div class="overlay" style="background: rgba(0,0,0,.3)"></div>
						<div class="container">
							<div class="row fullscreen justify-content-center align-items-center">
								<div class="col-md-10 col-12">
					...
					<div class="single-info row mt-40">
						<div class="col-lg-6 col-md-12 mt-120 text-center no-padding info-left">
							<div class="info-thumb">
								<img src="<?php echo base_url()?>asset/img/about-img.jpg" class="img-fluid" alt="">
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center d-flex">
						<div class="active-works-carousel mt-40 col-lg-8">
							<div class="item">
								<img class="img-fluid" src="<?php echo base_url()?>asset/img/why.jpg" alt="">
					...
					<div class="row no-padding">
						<div class="active-gallery">
							<div class="item single-gallery">
								<img src="<?php echo base_url()?>asset/img/g1.jpg" alt="">
							</div>	
							<div class="item single-gallery">
								<img src="<?php echo base_url()?>asset/img/g2.jpg" alt="">
							</div>	
							<div class="item single-gallery">
								<img src="<?php echo base_url()?>asset/img/g3.jpg" alt="">
							</div>	
							<div class="item single-gallery">
								<img src="<?php echo base_url()?>asset/img/g4.jpg" alt="">
							</div>	
							<div class="item single-gallery">
								<img src="<?php echo base_url()?>asset/img/g5.jpg" alt="">
							</div>	
							<div class="item single-gallery">
								<img src="<?php echo base_url()?>asset/img/g6.jpg" alt="">
							</div>																		
						</div>
					</div>
				</div>	
			...
			<section class="video-area pt-40 pb-40">
				...
				<div class="container">
					<div class="video-content">
						<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="<?php echo base_url()?>asset/img/play-btn.png" alt=""></a>
